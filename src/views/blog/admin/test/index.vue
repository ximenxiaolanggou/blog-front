...
import {findById} from "../../../../api/blog/article";

// 2. 获取DOM引用
const vditor = ref()

const saveContent = () => {
  alert(vditor.value.getValue())
};

// 文章详情
const articleDetail = async () => {
  let res = await findById(146)
...
//     console.dir(vditor.value)
//     console.dir(vditor.value.vditor.toolbar.elements.customTool)
//     console.dir(vditor.value.vditor.toolbar.elements.customTool.click)
//     vditor.value.vditor.toolbar.elements.customTool.click(event);
//   }
// })
</script>
